...
The first, AdHocAgent utility search `AdHocAgent.properties` file in the  current/working directory: the place where generated by server files 
will be deployed, and then in the self utility binary class folder. 
